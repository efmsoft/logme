...
bool Logger::CommandHelp(Logme::StringArray& arr, std::string& response)
{
  ...
  response +=
    ...
    "list                                           List channels\n"
    "logstat start|stop|status|reset                Control log-site statistics collection\n"
    "logstat top [--sort bytes|records] [--limit n] Display top log source locations\n"
    "logstat channels [--sort bytes|records]        Display source channel statistics\n"
    "logstat outputs [--backend type] [--sort ...]  Display source sites by backend output\n"
    "logstat backends [--backend type] [--sort ...] Display backend output totals\n"
    ...
    "subsystem --check name                         Query subsystem filters and level\n"
    "subsystem --set-level name level               Set subsystem level override\n"
    "subsystem --remove-level name                  Remove subsystem level override\n"
    "subsystem --clear                              Clear all subsystem filters and levels\n"
    "subsystem --clear-blocked                      Clear blocked subsystem list\n"
    "subsystem --clear-allowed                      Clear allowed subsystem list\n"
    "subsystem --clear-levels                       Clear subsystem level overrides\n"
